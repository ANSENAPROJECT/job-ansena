              ...
              <View style={{minHeight: 200, backgroundColor: 'white'}}>
                ...
                <View style={styles.headerCollapse}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <Text
                      style={{...styles.txtTitleCollapse, color: 'lightgrey'}}>
                      Sub Jobs
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Text style={{...styles.txtTitleRight, color: 'lightgrey'}}>
                      3
                    </Text>
                    <Image
                ...
                <View style={{marginTop: 20}}>
                  <View style={{...styles.flexJustify, marginBottom: 20}}>
                    <View style={{...styles.flexRow, flex: 1}}>
                      ...
                      <Text style={{color: 'lightgrey'}}>29 Jan 2021</Text>
                    </View>
                    <View style={{...styles.flexRow, flex: 1}}>
                      <Image source={CoAdminView} style={styles.imgSize} />
                      <Text style={{color: 'lightgrey'}}>Gisela</Text>
                    </View>
                  </View>
                  <View style={{...styles.flexJustify, marginBottom: 20}}>
                    <View style={{...styles.flexRow, flex: 1}}>
                      <Image source={DeadlineStart} style={styles.imgSize} />
                      <Text style={{color: 'lightgrey'}}>From 29 Jan</Text>
                    </View>
                    <View style={{...styles.flexRow, flex: 1}}>
                      <Image source={DeadlineEnd} style={styles.imgSize} />
                      <Text style={{color: 'lightgrey'}}>Until 6 Feb</Text>
                    </View>
                  </View>
                  <View style={{...styles.flexJustify, marginBottom: 20}}>
                    <View style={{...styles.flexRow, flex: 1}}>
                      <Image source={CrewView} style={styles.imgSize} />
                      <Text style={{color: 'lightgrey'}}>3 Crew</Text>
                    </View>
                    <View style={{...styles.flexRow, flex: 1}}>
                      <Image source={LeaderView} style={styles.imgSize} />
                      <Text style={{color: 'lightgrey'}}>Angga</Text>
                    </View>
                  </View>
                </View>
